function [xPhys]=MinLenScaleS_MOD(xPhys,maxloop,rminV,HS,HsS,figNum,F,U,freedofs,neleD,elloc,el_D,passive_usr)
parameters
% Boxcar weighting functions
step_s = 3/12;
step_v = 3/12;
step_xv = .26;
alpha=15;
